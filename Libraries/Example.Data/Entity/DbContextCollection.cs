...
namespace Example.Data.Entity
{
    ...
    {
        private Dictionary<(Type, string), IDbContext> _initializedDbContexts;
        ...
        internal Dictionary<(Type, string), IDbContext> InitializedDbContexts { get { return _initializedDbContexts; } }
        ...
        public DbContextCollection(bool readOnly = false, IsolationLevel? isolationLevel = null, IDbContextFactory dbContextFactory = null)
        {
            ...
            _initializedDbContexts = new Dictionary<(Type, string), IDbContext>();
        ...
        public TDbContext Get<TDbContext>(string nameOrConnectionString) where TDbContext : class, IDbContext
        {
            ...
            if (!_initializedDbContexts.ContainsKey((requestedType, nameOrConnectionString)))
            {
                // First time we've been asked for this particular DbContext type.
                // Create one, cache it and start its database transaction if needed.
                var dbContext = _dbContextFactory != null
                    ? _dbContextFactory.CreateDbContext<TDbContext>(nameOrConnectionString)
                    : (TDbContext)Activator.CreateInstance(typeof(TDbContext), nameOrConnectionString);

                _initializedDbContexts.Add((requestedType, nameOrConnectionString), dbContext);
            ...
            return _initializedDbContexts[(requestedType, nameOrConnectionString)] as TDbContext;
        }
